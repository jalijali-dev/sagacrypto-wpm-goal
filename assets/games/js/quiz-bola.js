...
(function () {
  ...
  var QUESTION_BANK = [
    ...
    { q: 'Negara mana yang paling banyak juara Piala Dunia FIFA (per 2022)?', options: ['Jerman', 'Argentina', 'Italia', 'Brasil'], correctIndex: 3 },
    ...
    { q: 'Piala Dunia FIFA 2026 akan diselenggarakan di negara mana (co-host, 3 negara)?', options: ['Spanyol, Portugal, Maroko', 'Amerika Serikat, Kanada, Meksiko', 'Inggris, Irlandia, Skotlandia', 'Arab Saudi, Mesir, Yordania'], correctIndex: 1 },
    { q: 'Siapa pencetak gol terbanyak sepanjang sejarah Piala Dunia FIFA (per 2022)?', options: ['Miroslav Klose', 'Pele', 'Lionel Messi', 'Ronaldo Nazario'], correctIndex: 0 },
    ...
    { q: 'Berapa ukuran standar diameter bola sepak (dalam cm, kira-kira)?', options: ['sekitar 58 cm keliling wilayah bola / diameter ~22 cm', 'sekitar 68-70 cm keliling bola', 'sekitar 90 cm keliling bola', 'sekitar 45 cm keliling bola'], correctIndex: 1 },
  ...
  /**
   * Picks QUESTIONS_PER_SESSION random questions from the bank, and
   * independently shuffles each picked question's own options (so the
   * correct answer isn't always in the same slot) — returns fresh
   * objects with a re-derived correctIndex, never mutating QUESTION_BANK.
   */
  function pickSessionQuestions() {
    var picked = shuffle(QUESTION_BANK).slice(0, QUESTIONS_PER_SESSION);
